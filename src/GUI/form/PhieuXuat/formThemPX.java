 ...
 * @author ADMIN
 */
public class formThemPX extends javax.swing.JPanel {

    /**
     * Creates new form formThemPX
     */
    public formThemPX() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtMaThuoc.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txtMaThuoc.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(204, 204, 204)));
        txtMaThuoc.setMinimumSize(new java.awt.Dimension(180, 25));
        txtMaThuoc.setName(""); // NOI18N
        txtMaThuoc.setPreferredSize(new java.awt.Dimension(180, 25));
        pMaSP.add(txtMaThuoc);
        ...
        cbbDanhMuc.setMinimumSize(new java.awt.Dimension(80, 30));
        cbbDanhMuc.setPreferredSize(new java.awt.Dimension(80, 30));
        pTimKiem.add(cbbDanhMuc);
        ...
        btnTimKiem1.setBackground(new java.awt.Color(0, 204, 51));
        btnTimKiem1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnTimKiem1.setForeground(new java.awt.Color(255, 255, 255));
        btnTimKiem1.setText("Thêm");
        btnTimKiem1.setMaximumSize(new java.awt.Dimension(100, 30));
        btnTimKiem1.setMinimumSize(new java.awt.Dimension(100, 30));
        btnTimKiem1.setPreferredSize(new java.awt.Dimension(100, 30));
        pThemSP.add(btnTimKiem1);
        ...
        tableSP.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SP", "Tên SP", "Thành phần", "Giá nhập", "Giá bán", "HSD", "ĐVT", "Xuất xứ", "Tồn kho"
            }
        ) {
        ...
        txtNV.setMinimumSize(new java.awt.Dimension(200, 25));
        txtNV.setPreferredSize(new java.awt.Dimension(200, 25));
        pNhanVien.add(txtNV);
