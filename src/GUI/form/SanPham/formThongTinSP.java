 ...
 * @author ADMIN
 */
public final class formThongTinSP extends javax.swing.JDialog {
     ...
     * @param sp
     */
    public formThongTinSP(java.awt.Frame parent, boolean modal, SanPham sp) {
        super(parent, modal);
        initComponents();
        loadComboBoxData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formThongTinSP.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
