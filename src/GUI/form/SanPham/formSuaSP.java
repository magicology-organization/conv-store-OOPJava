 ...
 * @author ADMIN
 */
public class formSuaSP extends javax.swing.JDialog {
    private String maSP;
     ...
     */
    public formSuaSP(java.awt.Frame parent, boolean modal, String maSP) {
        super(parent, modal);
        initComponents();
        this.maSP = maSP;
        loadComboBoxData();
    ...
    private void loadComboBoxData() {
        ...
        for (DanhMuc dm : danhMucList) {
            comboDanhMuc.addItem(dm.getTenDM().trim());
        }

        List<DonViTinh> dvtList = new DonViTinhDAO().findAll();
        for (DonViTinh dvt : dvtList) {
            comboDVT.addItem(dvt.getTenDVT().trim());
        }

        List<XuatXu> xxList = new XuatXuDAO().findAll();
        for (XuatXu xx : xxList) {
            comboXuatXu.addItem(xx.getTenXX().trim());
        }
    }

    private void loadThongTinSP(String maSP) {
        SanPham sp = new SanPhamDAO().findById(maSP).orElse(null);
        if (sp != null) {
            ...
            comboDanhMuc.setSelectedItem(sp.getDanhMuc().getTenDM());
            comboDVT.setSelectedItem(sp.getDonViTinh().getTenDVT());
            comboXuatXu.setSelectedItem(sp.getXuatXu().getTenXX());
    ...
    private void initComponents() {
        ...
        DateHSD.setDateFormatString("dd, MMM,yyyy");
