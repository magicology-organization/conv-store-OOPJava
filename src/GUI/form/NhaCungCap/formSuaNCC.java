...
public class formSuaNCC extends javax.swing.JDialog {
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (nccSua == null) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Không tìm thấy thông tin nhà cung cấp cần sửa!",
        ...
        // Regex kiểm tra
        String regexTen = "^[\\p{L} ]{3,50}$";
        String regexSDT = "^(0\\d{9,10})$";
        String regexDiaChi = "^[\\p{L}0-9 ,.\\-/#]{5,100}$";
        ...
        if (!ten.matches(regexTen)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Tên không hợp lệ (3–50 ký tự, chỉ gồm chữ và khoảng trắng)",
                    "Lỗi", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (!sdt.matches(regexSDT)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Số điện thoại không hợp lệ (phải bắt đầu bằng 0, 10–11 số)",
                    "Lỗi", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        if (!diaChi.matches(regexDiaChi)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Địa chỉ không hợp lệ (5–100 ký tự, cho phép .,/-#)",
                    "Lỗi", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        nccSua.setMaNCC(ma);
        nccSua.setTenNCC(ten);
        nccSua.setSdt(sdt);
        nccSua.setDiaChiNCC(diaChi);

        DAO.PhieuNhap.NhaCungCapDAO dao = new DAO.PhieuNhap.NhaCungCapDAO();
        boolean ok = dao.update(nccSua);
        if (ok) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Cập nhật thành công!",
    ...
    public static void main(String args[]) {
        ...
        // java.util.logging.Logger.getLogger(formSuaNCC.class.getName()).log(java.util.logging.Level.SEVERE,
        // null,
        // ex);
