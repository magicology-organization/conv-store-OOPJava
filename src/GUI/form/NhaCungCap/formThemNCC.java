...
public class formThemNCC extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblThemKH.setText(" Thêm nhà cung cấp");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnThemActionPerformed
        ...
        // --- Biểu thức chính quy ---
        String regexTen = "^[\\p{L} ]{3,50}$"; // Chỉ cho phép chữ cái và khoảng trắng, dài 3–50 ký tự
        String regexSDT = "^(0\\d{9,10})$"; // Bắt đầu bằng 0, tổng 10 hoặc 11 số
        String regexDiaChi = "^[\\p{L}0-9 ,.\\-/#]{5,100}$"; // Cho phép chữ, số và vài ký tự đặc biệt
        ...
        if (!ten.matches(regexTen)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Tên nhà cung cấp không hợp lệ!\nChỉ được chứa chữ và khoảng trắng (3–50 ký tự).",
                    "Lỗi nhập liệu", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (!diaChi.matches(regexDiaChi)) {
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Địa chỉ không hợp lệ!\nĐộ dài từ 5–100 ký tự, chỉ chứa chữ, số và ký tự .,/-#",
                    "Lỗi nhập liệu", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (success) {
                ...
                javax.swing.JOptionPane.showMessageDialog(this,
                        "Không thể thêm nhà cung cấp (có thể mã bị trùng)!",
                        "Thất bại", javax.swing.JOptionPane.ERROR_MESSAGE);
            }

        } catch (Exception ex) {
            ex.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this,
                    "Đã xảy ra lỗi khi thêm nhà cung cấp!",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formThemNCC.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
