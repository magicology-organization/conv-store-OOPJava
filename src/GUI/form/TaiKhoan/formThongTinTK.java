...
public class formThongTinTK extends javax.swing.JDialog {
     ...
     * @param tk
     */
    public formThongTinTK(java.awt.Frame parent, boolean modal, TaiKhoan tk) {
        super(parent, modal);
        initComponents();
        loadComboBoxData();
        setThongTinTK(tk);
    ...
    private void loadComboBoxData() {
        ...
        List<Entity.NhanVien.NhanVien> nvList = new DAO.NhanVien.NhanVienDAO().findAll();

        cboNhanVien.removeAllItems(); // Xóa item cũ
        for (Entity.NhanVien.NhanVien nv : nvList) {
            // Thêm vào ComboBox theo định dạng "maNV - tenNV"
            cboNhanVien.addItem(nv.getTenNV());
        }
    }

    private void setThongTinTK(Entity.TaiKhoan.TaiKhoan tk) {
        if (tk != null) {
            txtMaTK.setText(tk.getMaTK());
            txtTK.setText(tk.getTenTK());
            txtMK.setText(tk.getMatKhauTK());
            if (tk.getNhanVien() != null) {
                DAO.NhanVien.NhanVienDAO nvDao = new DAO.NhanVien.NhanVienDAO();
                Entity.NhanVien.NhanVien nv = nvDao.findById(tk.getNhanVien().getMaNV()).orElse(null);

                if (nv != null) {
                    tk.setNhanVien(nv);
                    cboNhanVien.setSelectedItem(nv.getTenNV());
                }
            }
        }
    }
    ...
    private void initComponents() {
        ...
        cboNhanVien.setBackground(new java.awt.Color(242, 242, 242));
    ...
    public static void main(String args[]) {
        ...
        // java.util.logging.Logger.getLogger(formThongTinTK.class.getName()).log(java.util.logging.Level.SEVERE,
        // null, ex);
