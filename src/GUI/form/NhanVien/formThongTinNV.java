...
public class formThongTinNV extends javax.swing.JDialog {
     ...
     * @param nv
     */
    public formThongTinNV(java.awt.Frame parent, boolean modal, NhanVien nv) {
        super(parent, modal);
        initComponents();
        groupGioiTinh();
        groupChucVu();
    ...
    private void initComponents() {
        ...
        tilte.setText("Thông tin nhân viên");
        ...
        dateNgaySinh.setDateFormatString("dd/MM/yyyy");
        dateNgaySinh.setDoubleBuffered(false);
    ...
    public static void main(String args[]) {
        ...
        // java.util.logging.Logger.getLogger(formThongTinNV.class.getName()).log(java.util.logging.Level.SEVERE,
        // null, ex);
