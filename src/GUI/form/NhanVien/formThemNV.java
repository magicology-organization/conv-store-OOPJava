...
public class formThemNV extends javax.swing.JDialog {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnThemActionPerformed
        ...
        try {
            ...
            String maNV = txtMa.getText().trim(); // hoặc tự sinh mã nếu muốn
            if (maNV.isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formThemNV.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
