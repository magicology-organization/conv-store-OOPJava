...
public class chart extends javax.swing.JPanel {
    ...
    private final int seriesSpace = 8;
    ...
    public void updateChartWidth() {
        ...
        int bars = model.size();
        int totalSeriesWidth = (seriesSize + seriesSpace) * bars;
        int minWidth = 1200; // width tối thiểu viewport
        int width = Math.max(totalSeriesWidth, minWidth);

        blankPlotChart.setPreferredSize(new java.awt.Dimension(width, blankPlotChart.getHeight()));
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(panelLegend, javax.swing.GroupLayout.DEFAULT_SIZE,
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(blankPlotChart, javax.swing.GroupLayout.PREFERRED_SIZE, 299,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(panelLegend, javax.swing.GroupLayout.PREFERRED_SIZE, 25,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addContainerGap()));
