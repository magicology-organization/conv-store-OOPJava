...
import GUI.form.TaiKhoan.formThemTK;
...
public class frmTaiKhoan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        titleName.setText("Danh sách tài khoản");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnThemActionPerformed
        ...
        formThemTK dialog = new formThemTK(parentFrame, true); // Mở formThemKH
        dialog.setLocationRelativeTo(this);
        dialog.setVisible(true);

        // Sau khi đóng formThemTK, gọi lại phương thức để làm mới bảng
        loadDataTable();
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnXoaActionPerformed
        ...
        String maTK = table.getValueAt(selectedRow, 1).toString();

        int confirm = JOptionPane.showConfirmDialog(
                this,
                "Bạn có chắc muốn xoá tài khoản: " + maTK + " ?",
                "Xác nhận xoá",
        ...
        try {
            ...
            boolean success = tkDAO.delete(maTK);
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(this,
                        "Không thể xoá! Tài khoản không tồn tại hoặc đang được tham chiếu.");
            }
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnSuaActionPerformed
        ...
        GUI.form.TaiKhoan.formSuaTK dialog = new GUI.form.TaiKhoan.formSuaTK(parent, true, tk);
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        if (list.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Không tìm thấy tài khoản phù hợp với: " + keyword);
        }
