...
public class frmSearchNhaCungCap extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtDiaChi.setMaximumSize(new java.awt.Dimension(350, 32));
        txtDiaChi.setMinimumSize(new java.awt.Dimension(350, 32));
        txtDiaChi.setPreferredSize(new java.awt.Dimension(350, 30));
        pTimKiem_Row4_Col2.add(txtDiaChi);
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTimActionPerformed
        ...
        NhaCungCapDAO dao = new NhaCungCapDAO();
        List<NhaCungCap> list = dao.search(ma, ten, sdt, diaChi);
