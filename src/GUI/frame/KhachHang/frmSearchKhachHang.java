...
public class frmSearchKhachHang extends javax.swing.JPanel {
    ...
    private void loadCboGioiTinh() {
        ...
        cboGioiTinh.setSelectedIndex(0); // mặc định chọn "Tất cả"
    }
    ...
    private void initComponents() {
        ...
        scrollTableCenter1 = new javax.swing.JScrollPane();
        ...
        scrollTableCenter1.setToolTipText("");
        scrollTableCenter1.setMinimumSize(new java.awt.Dimension(1200, 500));
        ...
        scrollTableCenter1.setViewportView(table);

        scrollTableCenter.setViewportView(scrollTableCenter1);
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnTimActionPerformed
        ...
        KhachHangDAO dao = new KhachHangDAO();
        List<KhachHang> list = dao.search(maKH, tenKH, sdt, gioiTinh);
    ...
    private javax.swing.JScrollPane scrollTableCenter1;
